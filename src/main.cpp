...
int main() {
    ...
    while (!ShouldQuit()) {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::SliderFloat("Wind Noise Scale", &params.windNoiseScale, 0.0f, 10.0f);
            ImGui::SliderFloat("Wind Strength", &params.windStrength, 0.0f, 10.0f);
            ImGui::SliderFloat("Gravity Strength", &params.gravityStrength, 0.0f, 10.0f);
